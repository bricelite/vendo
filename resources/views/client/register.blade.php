                ...
                <div class="glass-solid rounded-2xl p-6 shadow-sm">
                    ...
                    <form method="POST" action="{{ route('client.register.post') }}" class="mt-6 space-y-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="telephone" class="block mt-1 w-full rounded-xl" type="tel" name="telephone" :value="old('telephone')" required autocomplete="tel" placeholder="Ex. : 01 97 12 34 56" />
