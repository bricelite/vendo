<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" novalidate
        ...
        <div x-ref="etape-3" x-show="etape === 3" x-transition.opacity.duration.200ms>
            ...
            <div class="mt-6 space-y-3">
                <button type="button" @click="continuer()" :disabled="envoiEnCours"
                        class="w-full inline-flex items-center justify-center gap-2 px-4 py-3 bg-principale border border-transparent rounded-xl font-semibold text-sm text-white tracking-wide transition ease-in-out duration-150 disabled:opacity-50">
