<nav class="sticky top-0 z-30 glass rounded-none border-t-0 border-x-0 md:hidden">
    <div class="max-w-2xl mx-auto px-4 h-16 flex items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-1 shrink-0">
            ...
            {{-- Notification bell (point rouge si non lues — à brancher plus tard) --}}
            <span class="relative inline-flex items-center justify-center h-10 w-10 rounded-full text-texte-secondaire">
                <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.6">
