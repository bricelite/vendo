<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-texte-secondaire">
            La suppression est définitive : vos produits et vos données seront perdus.
        </p>
    </header>
    ...
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
            ...
            <p class="mt-1 text-sm text-texte-secondaire">
                Toutes vos données seront supprimées définitivement. Entrez votre mot de passe pour confirmer.
            </p>
